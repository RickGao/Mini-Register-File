...
async def test_register_file(dut):
    ...
    # Test case 1: Write value 2 to register 1 and value 5 to register 2, then read both back
    ...
    # Test case 2: Write to register 0 and confirm it remains zero (RISC-V convention), and check register 1 still has 2
    ...
    # Test case 3: Write and read all registers to check boundary values
    ...
    # Test case 4: Overwrite a register and check the last write persists
    ...
    # Test case 5: Write to multiple registers, reset, and verify all registers are cleared
